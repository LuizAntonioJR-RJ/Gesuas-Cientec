...
<meta name="description" content="<?php echo $data['descricao'];?>">
                ...
                <div class="navbar-collapse-header">
                    <div class="row">
                        <div class="col-6 collapse-brand">
                            <a href="<?php echo $data['pastaSistema'];?>">
            ...
            <div class="container">
                <div class="row justify-content-center">
                    <div class="col-12 col-md-10 text-center mb-5 mb-md-7">
                        ...
                        <p class="lead mb-4 mb-lg-5"><?php echo $data['texto']?></p>
                         
						<form method='get'>
							<h4>Buscar Usuário</p>
							<label for="nis">Digite o NIS</label>
							<input type='text' id="nis" name="nis" maxlength="11">
